 ...
 */
class WithdrawTransactionLog extends Model
{
    /**
     * 表名
     */
    protected $table = 'luna_withdraw_transaction_logs';
    ...
    {
        return $this->belongsTo(WithdrawTransaction::class, 'transaction_id');
    }
     ...
     * 是否为审核日志
     */
    public function isReviewLog(): bool
    {
        return in_array($this->to_status, [
            WithdrawTransaction::STATUS_PROCESSING,
            WithdrawTransaction::STATUS_REJECTED
        ]) && $this->from_status === WithdrawTransaction::STATUS_REVIEWING;
    }
}