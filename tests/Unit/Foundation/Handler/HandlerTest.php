...
test('对于不存在的实体处理器返回 null', function () {
    $handler = $this->handler->entityHandler('non.existing');
    
    expect($handler)->toBeNull();
});

test('可以按组获取实体处理器', function () {
